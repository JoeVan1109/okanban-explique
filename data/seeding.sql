...
INSERT INTO "card" 
  (id, position, title, content, color, list_id)
VALUES
  (1, 3, 'Savon','Le contenu de la carte', '#FF00FF', 1),
  (2, 2, 'Chartreuse','Le contenu de la carte', NULL, 1),
  (3, 1, 'Concombre','Le contenu de la carte', '#00FF00', 1),

  (4, 1, 'Dormir','Le contenu de la carte', '#FF0000', 2),
  (5, 2, 'Nourrir le chat','Le contenu de la carte', NULL, 2),
  (6, 2, 'Devenir le meilleur dresseur','Le contenu de la carte', NULL, 2),

  (7, 1, 'Maman le 01/01/1970','Le contenu de la carte', '#0000FF', 3)
;
